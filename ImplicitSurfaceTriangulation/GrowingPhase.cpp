...
Implicit::Tessellation::GrowingPhase::GrowingPhase(GlmPolyMesh& mesh, Object& object) 
    : 
    Phase(mesh, mesh), 
    mesh(mesh), 
    object(object), 
...
void Implicit::Tessellation::GrowingPhase::generateSeedTriangle()
{
    ...
    const glm::dvec3 finalPoint = Triangle::getEtp(seedPoint, nextPoint, b); // object.Project();
...
double Implicit::Tessellation::GrowingPhase::getRoc(const glm::dvec3& point) const
{
	double k1, k2;
...
OpenMesh::SmartFaceHandle Implicit::Tessellation::GrowingPhase::addNewFace(const glm::dvec3& pointA, const glm::dvec3& pointB, const glm::dvec3& pointC)
{
...
OpenMesh::SmartFaceHandle Implicit::Tessellation::GrowingPhase::addNewFace(const OpenMesh::VertexHandle& pointA, const OpenMesh::VertexHandle& pointB, const glm::dvec3& pointC, double newTriangleLongestSide)
{
...
bool Implicit::Tessellation::GrowingPhase::expandEdge(OpenMesh::SmartEdgeHandle edge, OpenMesh::SmartFaceHandle& newFace)
{
    ...
    const glm::dvec3 equilateralPoint = Triangle::getEtp(P0, P1, altitude);
...
bool Implicit::Tessellation::GrowingPhase::applyEarCutting(const OpenMesh::SmartFaceHandle& newFace)
{
    bool earCut = false;
...
bool Implicit::Tessellation::GrowingPhase::Completed() const
{
	return !meshChanged;
}

void Implicit::Tessellation::GrowingPhase::SetRho(double rho)
{
    this->rho = rho;
}

double Implicit::Tessellation::GrowingPhase::GetLongestTriangleSide() const
{
    return longestSide;
}